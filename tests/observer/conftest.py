...
from auditor.graph.payloads import LogReport
from auditor.observer.events import EventQueue
from auditor.observer.payloads import ReposPayload, RunsView
...
class FakeReaders(Readers):
    ...
    The two counters are what lets a test prove a 304 ran no query (P14).
    """
