...
GROUPS: dict[str, list[tuple[str, str, str]]] = {
    "style": [
        ...
        ("PY-STYLE-INLINE-IMPORT", "def f():\n    import os\n    return os", "import os\ndef f():\n    return os"),
        ("PY-STYLE-IF-FALSE-IMPORT", "if False:\n    import os\n", "from typing import TYPE_CHECKING\nif TYPE_CHECKING:\n    import os\n"),
    ],
    "typing_rules": [
        ("PY-TYPING-MISSING-HINTS", "def f(x):\n    return x", "def f(x: int) -> int:\n    return x"),
        ("PY-TYPING-UNTYPED-DICT", "def f() -> dict[str, Any]:\n    return {}", "def f() -> int:\n    return 1"),
    ],
    "correctness": [
        ("PY-CORRECT-BROAD-EXCEPT", "try:\n    x()\nexcept Exception:\n    pass", "try:\n    x()\nexcept ValueError as e:\n    log(e)"),
        ("PY-CORRECT-SWALLOWED-EXCEPTION", "try:\n    x()\nexcept ValueError:\n    pass", "try:\n    x()\nexcept ValueError:\n    log()"),
    ],
    "async_rules": [
        ("PY-ASYNC-SYNC-IO", "async def f():\n    time.sleep(1)\n    await g()", "async def f():\n    await g()"),
        ("PY-ASYNC-UNLOCKED-LAZY-INIT", "class C:\n    def m(self):\n        if self._x is None:\n            self._x = 1", "class C:\n    def m(self):\n        with self._lock:\n            if self._x is None:\n                self._x = 1"),
        ("PY-ASYNC-DANGLING-TASK", "async def f():\n    asyncio.create_task(g())\n    await h()", "async def f():\n    t = asyncio.create_task(g())\n    await t"),
        ("PY-ASYNC-SEQUENTIAL-AWAITS", "async def f():\n    for x in xs:\n        await g(x)", "async def f():\n    await asyncio.gather(*[g(x) for x in xs])"),
        ("PY-ASYNC-NO-AWAIT-BODY", "async def f():\n    return 1", "async def f():\n    return await g()"),
    ],
    "config_rules": [
        ("PY-CONFIG-ADHOC-ENV", "x = os.environ.get('X')", "x = get_settings().x"),
        ("PY-CONFIG-IMPORT-TIME-IO", "data = requests.get('u')", "def load():\n    return requests.get('u')"),
    ],
    "oop": [
        ("PY-OOP-DATACLASS-IN-PYDANTIC", "@dataclass\nclass C:\n    x: int = 1", "class C(BaseModel):\n    x: int"),
        ("PY-OOP-CONSTRUCTOR-WALL", _WALL, "Model(a=1)"),
        ("PY-OOP-FLAT-FIELD-MODEL", _FLAT, "class M(BaseModel):\n    a: int\n    b: int"),
        ("PY-OOP-THIN-WRAPPER", "def f(x):\n    return g(x)", "def f(x):\n    y = g(x)\n    return y + 1"),
        ("PY-OOP-BUILDER-CLASS", "class FooBuilder:\n    def build(self):\n        return 1", "class FooBuilder:\n    def build(self):\n        return 1\n    def other(self):\n        return 2"),
        ("PY-OOP-DISPATCH-LADDER", _DISPATCH, "def f(x):\n    if x:\n        return 1\n    return 2"),
        ("PY-OOP-STATIC-METHOD-CLASS", "class C:\n    @staticmethod\n    def f():\n        return 1", "class C:\n    def f(self):\n        return 1"),
        ("PY-OOP-LONG-PARAM-LIST", "def f(a, b, c, d, e, g, h):\n    return 1", "def f(a, b):\n    return 1"),
        ("PY-OOP-GOD-CLASS", _GOD, "class C:\n    def m(self):\n        return 1"),
        ("PY-OOP-HIGH-COMPLEXITY", _COMPLEX, "def f(x):\n    return x + 1"),
        ("PY-OOP-FREE-FN-ORCHESTRATOR", "def a():\n    return 1\ndef b():\n    return a()\ndef c():\n    return b()", "def only():\n    return 1"),
    ],
    "security/injection": [
        ("PY-SEC-DANGEROUS-EVAL", "eval(user_input)", "eval('1')"),
        ("PY-SEC-SHELL-INJECTION", "subprocess.run(cmd, shell=True)", "subprocess.run(['ls'])"),
        ("PY-SEC-SQL-STRING-BUILD", "cur.execute(f'select {x}')", "cur.execute('select ?', (x,))"),
        ("PY-SEC-DJANGO-RAW-SQL", "Model.objects.raw(f'select {x}')", "Model.objects.raw('select 1')"),
    ...
    "security/deserialize": [
        ...
        ("PY-SEC-XXE-UNSAFE-XML", "xml.etree.ElementTree.parse(f)", "import defusedxml.ElementTree\ndefusedxml.ElementTree.parse(f)"),
    ],
    "security/crypto": [
    ...
    "security/network": [
        ("PY-SEC-INSECURE-TLS", "requests.get(u, verify=False)", "requests.get(u, timeout=5)"),
        ("PY-SEC-REQUEST-NO-TIMEOUT", "requests.get(u)", "requests.get(u, timeout=5)"),
        ("PY-SEC-BIND-ALL-INTERFACES", "host = '0.0.0.0'", "host = '127.0.0.1'"),
        ("PY-SEC-PARAMIKO-AUTOADD", "client.set_missing_host_key_policy(paramiko.AutoAddPolicy())", "client.set_missing_host_key_policy(paramiko.RejectPolicy())"),
        ("PY-SEC-SSRF", "requests.get(url, timeout=5)", "requests.get('http://fixed', timeout=5)"),
    ],
    "security/framework": [
        ("PY-SEC-FLASK-DEBUG", "app.run(debug=True)", "app.run(debug=False)"),
        ("PY-SEC-JINJA-AUTOESCAPE-OFF", "env = Environment(loader=l)", "env = Environment(loader=l, autoescape=True)"),
